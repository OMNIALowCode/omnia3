...
Please download this [Contacts.csv](https://github.com/OMNIALowCode/omnia3/blob/master/docs/tutorialPics/modelingTutorial/Contacts.csv?raw=true), we'll be using it as a data source in this tutorial. 
